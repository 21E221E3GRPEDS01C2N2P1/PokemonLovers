    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="card-q" v-else>
                <span v-if="!startQuiz">
                    <b-card
                        img-src="https://uploads.jovemnerd.com.br/wp-content/uploads/2021/08/pokemon-unite-data-de-lancamento-mobile.jpg" img-alt="Pokém Group" img-top title="PokéQuiz" class="mb-2 card-img-dimensions">
                        <b-card-text>
