<template>
 <div class="container">
    <p><router-link class="sublinhado" to="/dashboard">Dashboard</router-link> &#8250; <router-link class="sublinhado" to="/searshprofile">Search Profile</router-link></p>
    <div class="accordion faq" role="tablist">
      <h1 class="alignment h1 mb-3 fw-normal">Search Profile</h1>
    </div>
    <br/>
