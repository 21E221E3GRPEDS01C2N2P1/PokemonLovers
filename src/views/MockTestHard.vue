<template>
<div class="container">
    <p><router-link class="sublinhado" to="/">Home</router-link> &#8250; <router-link class="sublinhado" to="/dashboard">Dashboard</router-link> &#8250; <router-link class="sublinhado" to="/dashboard/mocktesthard">PokéQuiz</router-link></p>
...
<script>
import mocktest from "../scripts/mocktesthard.js";
